...
inside the single layer model can be recduced. In the concrete hardware model, the 8-Bit
address line go through all the layer resolvers, which split them in a 4-Bit address line, which
